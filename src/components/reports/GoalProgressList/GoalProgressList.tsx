...
import type { CycleProgress, GoalProgress } from '@/domain/types'
...
export function GoalProgressList({ progress }: GoalProgressListProps) {
  return (
    <>
      ...
      <Note>
        ...
        {progress.cycleName} já percorridos. Barra à esquerda dela é meta atrasada
        para o ritmo da gestão.
      </Note>
    </>
  )
}
