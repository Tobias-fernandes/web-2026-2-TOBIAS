  ...
  return (
    ...
    >
      {Array.from({ length: count }, (_, index) => (
        <div key={index} className="rounded-xl border border-linha bg-papel-alto p-5">
  ...
  return (
    ...
    >
      {Array.from({ length: count }, (_, column) => (
        <div key={column} className="rounded-xl border border-linha bg-papel-alto p-3">
          ...
          <div className="flex flex-col gap-2.5">
            {Array.from({ length: column === 0 ? 2 : 1 }, (_, card) => (
              <div key={card} className="rounded-lg border border-linha bg-papel p-3">
