...
import { isDerivedEvent, MAX_CHIPS_PER_DAY, WEEKDAY_HEADERS } from './constants'
 ...
 */
export function MonthGrid({ days, onSelect }: MonthGridProps) {
  return (
                        ...
                        <span
                          ...
                          className={cn(
                            ...
                            isDerivedEvent(event)
                              ...
                              : BADGE_TONE_CLASSES[EVENT_KIND_TONES[event.kind]],
                            !isScheduledEvent(event) && 'line-through opacity-60',
