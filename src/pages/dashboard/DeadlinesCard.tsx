...
export function DeadlinesCard({
  ...
  return (
    <Card>
      <CardTitle action={<CardLink to={ROUTES.app.projects}>Ver quadro</CardLink>}>
              ...
              return (
                ...
                >
                  <div className="min-w-0">
                    <p className="m-0 text-base font-semibold">{project.name}</p>
                    <p className="m-0 text-sm text-tinta-suave">{project.stage}</p>
                  </div>
