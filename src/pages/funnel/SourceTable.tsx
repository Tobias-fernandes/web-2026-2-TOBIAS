...
export function SourceTable({ summary }: { summary: Loadable<FunnelSummary> }) {
  return (
    <QueryState query={summary} skeleton={<SkeletonTable columns={5} rows={3} />}>
      {(data) =>
        data.bySource.length === 0 ? null : (
          <Card className="mt-10">
            ...
            <Note>
              A origem que mais gera oportunidade quase nunca é a que mais fecha.
              Essa tabela é o que decide onde o comercial e o marketing gastam o ano.
            </Note>
          </Card>
        )
      }
