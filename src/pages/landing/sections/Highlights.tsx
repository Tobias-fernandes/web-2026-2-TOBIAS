  ...
  return (
    ...
    >
      <div className="env">
        ...
        <h2 className={`m-0 max-w-[26ch] ${HEADING}`}>
          Uma leitura mais precisa da sua gestão.
        </h2>
        ...
        <div className="mt-10 grid gap-x-10 gap-y-12 md:grid-cols-2">
          {HIGHLIGHTS.map((item, index) => (
            <article key={item.title}>
              <div
                aria-hidden
                className="overflow-hidden rounded-lg border border-linha"
              >
        ...
        <p className="mt-8 mb-0 text-2xs text-tinta-suave">
          Visualizações ilustrativas com dados de exemplo.
        </p>
      </div>
    </section>
  );
