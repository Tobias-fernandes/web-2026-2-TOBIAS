...
import type { Course, MemberRole, MemberStatus, WorkArea } from '@/domain/types'
    ...
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <SelectField
          label="Situação"
          value={value.status}
          onChange={(event) => set('status', event.target.value as MemberStatus)}
      ...
      <fieldset className="m-0 mt-2 border-0 p-0">
        ...
        <p className="mt-0 mb-3 text-xs text-tinta-suave">
          Cargo e carga valem só para esta gestão. Na virada da diretoria, a pessoa
          continua; a posição é registrada de novo.
        </p>
