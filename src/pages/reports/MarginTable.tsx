  ...
  return (
    <>
      ...
      <p className="mt-0 mb-5 max-w-[70ch] text-base leading-relaxed text-tinta-suave">
        O contrato dividido pelas horas que ele realmente consumiu. É o número
        que mostra que um projeto de R$ 4.800 entregue em 320 horas foi vendido
        a R$ 15 a hora — e o que deveria mudar a próxima proposta. Conta todas
        as horas do contrato, não só as do período filtrado acima.
      </p>
            ...
            {rows.map((row) => {
              ...
              return (
                <TableRow key={row.projectId}>
                  ...
                  <TableCell
                    className={overBudget ? "text-ambar" : "text-tinta-suave"}
                  >
