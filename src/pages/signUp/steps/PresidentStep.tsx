...
import type { PresidentDraft, SignUpFormState } from '../types'
...
export function PresidentStep({ value, onChange }: StepProps) {
  const president = value.president

  const set = <K extends keyof PresidentDraft>(key: K, next: PresidentDraft[K]) =>
