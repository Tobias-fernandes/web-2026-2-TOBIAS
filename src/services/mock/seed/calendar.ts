import type { CalendarEvent, Directorate, EventKind, IsoDate } from '@/domain/types'
...
export const SEED_CALENDAR_EVENTS: CalendarEvent[] = [
  event('evt-1', 'Reunião de diretoria executiva', 'meeting', 'presidency', '2026-09-07', {
  ...
  event('evt-2', 'Alinhamento semanal de projetos', 'meeting', 'projects', '2026-09-09', {
    audience: 'directorate',
    startTime: '18:30',
    endTime: '19:30',
    onlineUrl: 'https://meet.google.com/altotech-projetos',
    createdBy: 'mem-3',
    description: 'Status de cada projeto em execução e consumo do orçamento de horas.',
  }),
  event('evt-3', 'Capacitação: escrita de proposta comercial', 'training', 'commercial', '2026-09-10', {
    startTime: '19:00',
    endTime: '21:00',
    createdBy: 'mem-10',
    description:
  ...
  event('evt-4', 'Reunião de diretoria executiva', 'meeting', 'presidency', '2026-09-14', {
    audience: 'directorate',
    description: 'Pauta fixa: funil, projetos, caixa e pessoas.',
  }),
  event('evt-5', 'Visita técnica — Transportes Vale Verde', 'commercial', 'commercial', '2026-09-16', {
    startTime: '14:00',
    endTime: '16:00',
  ...
  event('evt-6', 'Entrega do painel de indicadores da frota', 'deadline', 'projects', '2026-09-30', {
    allDay: true,
    startTime: null,
    endTime: null,
    location: 'Remoto',
  ...
  event('evt-7', 'Abertura do processo seletivo 2026.2', 'selection', 'people', '2026-09-21', {
    endsAt: '2026-09-25',
    allDay: true,
    startTime: null,
    endTime: null,
  ...
  event('evt-8', 'Dinâmica em grupo do processo seletivo', 'selection', 'people', '2026-09-29', {
    startTime: '18:00',
    endTime: '21:00',
    createdBy: 'mem-9',
    description: 'Três rodadas de dinâmica. Cada diretor acompanha uma bancada.',
  }),
  event('evt-9', 'Reunião geral de membros', 'meeting', 'presidency', '2026-09-24', {
    startTime: '19:00',
    endTime: '20:00',
    description:
      'Prestação de contas do trimestre para toda a EJ: faturamento, projetos entregues e o que vem no último trimestre.',
  }),
  event('evt-10', 'Integração de novos membros', 'social', 'people', '2026-09-26', {
    startTime: '18:00',
    endTime: '22:00',
    location: 'Espaço de convivência do campus',
    createdBy: 'mem-9',
    description: 'Boas-vindas aos aprovados e confraternização de fim de trimestre.',
  }),
  event('evt-11', 'Planejamento editorial de outubro', 'meeting', 'marketing', '2026-09-28', {
    audience: 'directorate',
    startTime: '18:30',
    endTime: '20:00',
    onlineUrl: 'https://meet.google.com/altotech-marketing',
    createdBy: 'mem-4',
    description: 'Pauta do mês nas redes, ligada às origens que mais converteram no funil.',
  }),
  event('evt-12', 'Fechamento contábil de setembro', 'deadline', 'finance', '2026-10-05', {
    allDay: true,
    startTime: null,
    endTime: null,
    location: 'Remoto',
  ...
  event('evt-13', 'Entrega do site institucional', 'deadline', 'projects', '2026-10-09', {
    allDay: true,
    startTime: null,
    endTime: null,
    location: 'Remoto',
  ...
  event('evt-14', 'ENEJ — Encontro Nacional de Empresas Juniores', 'external', 'presidency', '2026-10-22', {
    endsAt: '2026-10-25',
    allDay: true,
    startTime: null,
    endTime: null,
  ...
  event('evt-15', 'Reunião de diretoria executiva', 'meeting', 'presidency', '2026-09-21', {
    audience: 'directorate',
    status: 'cancelled',
    description:
