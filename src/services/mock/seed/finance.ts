...
export const SEED_FINANCE_ENTRIES: FinanceEntry[] = [
  ...
  receivable(
    "fin-5",
    "Painel de indicadores — 1ª parcela",
    190_000,
    "2026-09-05",
    "2026-09-05",
    "prj-3",
  ...
  receivable(
    "fin-6",
    "Painel de indicadores — 2ª parcela",
    190_000,
    "2026-10-10",
    null,
    "prj-3",
  ...
  receivable(
    "fin-7",
    "Catálogo digital — parcela única",
    150_000,
    "2026-09-10",
    "2026-09-12",
    "prj-5",
  ...
  ),
  {
    ...receivable(
      "fin-9",
      "Patrocínio da Semana de Tecnologia",
      120_000,
      "2026-09-30",
      null,
      null,
  ...
  payable(
    "fin-11",
    "Assinaturas de ferramentas (setembro)",
    32_000,
    "2026-09-05",
    "2026-09-05",
    "tooling",
  ...
  payable(
    "fin-12",
    "Assinaturas de ferramentas (outubro)",
    32_000,
    "2026-10-05",
    null,
    "tooling",
  ...
  payable(
    "fin-13",
    "Material do processo seletivo 2026",
    18_000,
    "2026-08-28",
    "2026-08-28",
    "event",
  ...
  payable(
    "fin-14",
    "Capacitação de gestão de projetos",
    45_000,
    "2026-09-12",
    "2026-09-12",
    "training",
  ...
  payable(
    "fin-15",
    "Impulsionamento de campanha no Instagram",
    15_000,
    "2026-09-18",
    null,
    "event",
  ...
  payable(
    "fin-16",
    "Reembolso de deslocamento — visita à Vale Verde",
    8_400,
    "2026-09-02",
    "2026-09-04",
    "reimbursement",
  ...
  payable(
    "fin-17",
    "Taxas bancárias e tributos do trimestre",
    26_000,
    "2026-10-15",
    null,
    "tax",
  ...
  // ——— Entradas que não vêm de contrato ———
  {
    ...receivable(
      "fin-22",
      "Premiação do Desafio de Inovação da federação",
      100_000,
      "2026-09-19",
      "2026-09-19",
      null,
  ...
  },
  {
    ...receivable(
      "fin-23",
      "Mensalidades dos membros — setembro",
      36_000,
      "2026-09-10",
      "2026-09-10",
      null,
  ...
  // ——— Gestão anterior, mantida para comparar os ciclos ———
  {
    ...receivable(
      "fin-18",
      "Automação de relatórios — parcela final",
      270_000,
      "2025-05-30",
      "2025-06-02",
      "prj-6",
  ...
  },
  {
    ...receivable(
      "fin-19",
      "Portal de doações — parcela única",
      260_000,
      "2025-06-15",
      "2025-06-18",
      "prj-7",
