...
function projectLog({
  ...
  return weeks.flatMap((monday, weekIndex) =>
    members.flatMap((memberId, memberIndex) => {
      ...
      const hours =
        Math.round(
          perSlot * VARIATION[(weekIndex + memberIndex) % VARIATION.length] * 2,
        ) / 2;
      if (hours <= 0) return [];
...
function routineLog(
  ...
  return Array.from({ length: weeks }, (_, index) => {
    ...
    return date > TODAY
      ? null
      : entry(memberId, null, category, date, hours, description);
...
export const SEED_TIME_ENTRIES: TimeEntry[] = [
  ...
  ...routineLog(
    ...
    "commercial",
    2,
    "Reuniões com clientes e federação",
    3,
    28,
  ),
  ...routineLog(
  ...
  ...routineLog(
    ...
    "training",
    2,
    "Planejamento da capacitação interna",
    4,
    26,
  ),
  ...routineLog(
  ...
  ...routineLog(
    ...
    "internal",
    3,
    "Conciliação, contas a pagar e fechamento",
    3,
    29,
  ),
  ...routineLog(
  ...
  ...routineLog(
    ...
    "training",
    2,
    "Trilha de desenvolvimento dos trainees",
    4,
    24,
  ),
  ...routineLog(
    ...
    "commercial",
    4,
    "Follow-up de propostas e reuniões",
    2,
    29,
  ),
  ...routineLog(
    ...
    "internal",
    2,
    "Calendário editorial e redes sociais",
    4,
    29,
  ),
  ...routineLog(
  ...
  ...routineLog(
    ...
    "commercial",
    2,
    "Levantamento de requisitos com a Vale Verde",
    1,
    10,
  ),
  ...
  ...routineLog(
    ...
    "training",
    2,
    "Trilha de capacitação de trainees",
    4,
    6,
  ),
];
