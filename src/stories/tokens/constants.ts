...
export const TEXT_TOKENS: TextToken[] = [
  {
    name: "text-2xs",
    size: "12px",
    usage: "Selos, legendas de avatar, rótulos do menu",
  },
  {
    name: "text-xs",
    size: "13px",
    usage: "Dicas, notas de rodapé e cabeçalho de tabela",
  },
  {
    name: "text-sm",
    size: "14px",
    usage: "Texto secundário e células de tabela",
  },
  ...
  { name: "text-xl", size: "22px", usage: "Título de diálogo e destaques" },
  {
    name: "text-2xl",
    size: "28px",
    usage: "Título de página e números do painel",
  },
